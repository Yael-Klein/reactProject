...
export default function SignInS({history}) {
...
const handleSubmit = async (e)=>{
  e.preventDefault();
    try {
       ...
       let response = await Get1(`Student/Get?password=${state.password}`);
     
       if(response!=null)    
       {
        context.updateUser(response)
       
        history.push("/student_home_work")
       } 
       else
       history.push("/first")
    }
